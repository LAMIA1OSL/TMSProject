...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder authenticationManagerBuilder) throws Exception {
		...
		this.http = this.getSharedObject(HttpSecurity.class);
		http.csrf().disable()
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration
				.setAllowedOrigins(Arrays.asList("http://localhost","http://localhost:3000"));
	...
	private HttpSecurity getMyHttp() {
		return this.getSharedObject(HttpSecurity.class);
	}

	private <T> T getSharedObject(Class<T> clazz) {
